...
{
    public class CreateStudentWithParentAndGuardianValidator : AbstractValidator<CreateStudentWithParentAndGuardianCommand>
    {
        public CreateStudentWithParentAndGuardianValidator()
        {
